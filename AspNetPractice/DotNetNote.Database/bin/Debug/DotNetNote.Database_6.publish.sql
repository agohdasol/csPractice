...
GO
PRINT N'[dbo].[CommunityCampJoinMenbers]을(를) 만드는 중...';


GO
CREATE TABLE [dbo].[CommunityCampJoinMenbers] (
...
GO
PRINT N'[dbo].[CommunityCampJoinMenbers]에 대한 명명되지 않은 제약 조건을(를) 만드는 중...';


GO
ALTER TABLE [dbo].[CommunityCampJoinMenbers]
    ADD DEFAULT ('L') FOR [Size];
