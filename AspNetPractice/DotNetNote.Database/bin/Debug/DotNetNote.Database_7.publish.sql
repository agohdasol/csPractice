...
GO
PRINT N'[dbo].[CommunityCampJoinMembers]을(를) 만드는 중...';
...
GO
PRINT N'[dbo].[CommunityCampJoinMembers]에 대한 명명되지 않은 제약 조건을(를) 만드는 중...';


GO
ALTER TABLE [dbo].[CommunityCampJoinMembers]
