...
namespace Ch3
{
    public partial class FrmPageLoad : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
                Response.Write("1. 폼이 처음 로드할때에만 실행");
            if (Page.IsPostBack == false)
                Response.Write("2. 폼이 처음 로드할때에만 실행");
            Response.Write("3. 폼이 로드할때마다 실행");
        }
        ...
        public void BtnNewLoad_Click(object sender, EventArgs e)
        {
