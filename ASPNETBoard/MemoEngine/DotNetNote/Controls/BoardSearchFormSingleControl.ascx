...
<div style="text-align:center;">
  ...
  <asp:RequiredFieldValidator ID="ValSearchQuery" runat="server" ControlToValidate="SearchQuery" Display="None"
  ...
  <asp:Button ID="BtnSearch" runat="server" Text="검색" CssClass="form-control" Width="100px"
    Style="display:inline-block;" OnClick="BtnSearch_Click" />
</div>
<br />
